...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is ana.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a software development engineer.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i have a bachelors in computer science and data science.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("coffee connoisseur.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also love to travel.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
